...
<template>
      <div
        ...
        >
            ...
            <div>
                Generando <b>Crecimiento</b> <br>Estratégico desde <br><b>Bogotá</b> - Colombia.
            </div>
        </div>

           
            <div class="tw-flex tw-h-full tw-w-[250px] tw-flex-col tw-gap-4">
                <h2 class="tw-text-3xl max-md:tw-text-xl">Nosotros</h2>
                <div class="tw-flex tw-flex-col tw-gap-3 max-md:tw-text-sm">
                    <a href="#hero-section" class="footer-link">Inicio</a>
            ...
            <div class="tw-flex tw-h-full tw-w-[250px] tw-flex-col tw-gap-4">
                <div class="tw-mt-3 tw-text-lg tw-font-semibold">Siguenos</div>
