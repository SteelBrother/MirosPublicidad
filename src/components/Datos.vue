...
const links = [
  { name: 'Servicios Publicitarios', href: '#' },
  { name: 'Programa de Colaboración', href: '#' },
  { name: 'Nuestros Valores', href: '#' },
  { name: 'Conoce a Nuestro Equipo', href: '#' },
]

const stats = [
  { name: 'Clientes satisfechos', value: '500+' },
  { name: 'Proyectos completados', value: '200+' },
  { name: 'Experiencia en años', value: '10' },
  { name: 'Crecimiento anual', value: '25%' },
]
</script>
  ...
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Únete a Miros Publicidad</h2>
        <p class="mt-6 text-lg leading-8 text-gray-300">En Miros Publicidad, transformamos tu visión en resultados tangibles. Colaboramos para que tu marca brille en el mundo digital y físico.</p>
      </div>
